...
${target}-qmake-qt5 \
    ...
    QMAKE_LRELEASE=${QMAKE_LRELEASE} bitcoin-qt.pro

# Go for it. If successful, Windows binary will be written out to ./release/slimcoin-qt.exe
make clean && make -f Makefile.Release CXXFLAGS="-DWIN32 -DQT_GUI -DQT_NO_PRINTER -std=c++11 -march=i686" LDFLAGS="-march=i686"
